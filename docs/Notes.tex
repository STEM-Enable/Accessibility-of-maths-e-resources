...
\item
  ...
  \tightlist
  \item
    If you handwrite in OneNote then some aspects of it can be accessed but it is complicated\ldots{}
  \end{itemize}
\end{itemize}

\textbf{Don't avoid using something if it currently can't be made technically accessible but is important for other sorts of access.}
